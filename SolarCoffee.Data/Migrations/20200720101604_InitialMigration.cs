        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PrimaryAddressesId = table.Column<int>(nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Customers", x => x.Id);
                    table.ForeignKey(
                        name: "FK_Customers_CustomerAddresses_PrimaryAddressesId",
                        column: x => x.PrimaryAddressesId,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Customers_PrimaryAddressesId",
                table: "Customers",
                column: "PrimaryAddressesId");
        }
